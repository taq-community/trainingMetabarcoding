...
2. **Algorithme d'alignement global**: Utilise un algorithme de type Needleman-Wunsch optimisé pour comparer les séquences
3. **Calcul de score de similarité**: Pourcentage d'identité basé sur les positions qui correspondent (matches)
4. **Filtrage des résultats**: Application des seuils de qualité (QUERY_COV, MAX_ACCEPTS, MAX_REJECTS)
5. **Attribution taxonomique**: La séquence est assignée à l'espèce ayant la meilleure correspondance
:::
